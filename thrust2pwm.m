...
thrust = data(:, 2) * 0.00980665; % gram-force to Newtons
pwm_int16 = data(:,4)*65535/1e2;

figure, scatter(thrust, pwm_int16)

coeff = [thrust.^2 thrust] \ pwm_int16;

thrusts = linspace(0, max(thrust), 1000);
hold on, plot(thrusts, thrusts.^2 * coeff(1) + thrusts * coeff(2))